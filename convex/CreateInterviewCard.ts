...
export const Create_InterviewCard = mutation({
    args: {
    ...
    handler: async (ctx, args) => {
        try {
            ...
            const newCardId = await ctx.db.insert("generatedInterviewCards", {
                tags: args.tags,
            ...
            console.error("Error in InterviewCards mutation:", error);
            throw new Error("Failed to InterviewCards");
        }
    },
});